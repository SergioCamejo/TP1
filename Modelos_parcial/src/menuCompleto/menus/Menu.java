...
import menuCompleto.interfaces.Ejecutable;
import menuCompleto.interfaces.Mostrable;
import menuCompleto.opciones.OpcionDeMenu;
import menuCompleto.opciones.OpcionDeSalida;
...
public class Menu implements Ejecutable, Mostrable {
	...
	public ArrayList<OpcionDeMenu> copiaLista(){
		ArrayList<OpcionDeMenu> copiaLista = new ArrayList<>();
